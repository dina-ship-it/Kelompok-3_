    ...
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow p-6 text-center border-t-4 border-green-500">
                <p class="text-4xl font-bold text-green-600">1250</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
                $menus = [
                    ['title' => 'Kelola Dosen', 'desc' => 'Tambah, edit, dan hapus data dosen', 'color' => 'blue'],
                    ['title' => 'Kelola Mahasiswa', 'desc' => 'Tambah, edit, dan hapus data mahasiswa', 'color' => 'green'],
                    ['title' => 'Kelola Penelitian', 'desc' => 'Monitor dan kelola data penelitian', 'color' => 'gray'],
                    ['title' => 'Kelola Pengabdian', 'desc' => 'Monitor dan kelola data pengabdian', 'color' => 'yellow'],
                    ['title' => 'Kelola Prestasi', 'desc' => 'Monitor dan kelola data prestasi', 'color' => 'red'],
                ];
            @endphp
            ...
            <div class="bg-white rounded-2xl shadow p-6 hover:shadow-lg transition duration-300 border-t-4 border-{{ $menu['color'] }}-500">
                ...
                <a href="#" class="block text-center bg-{{ $menu['color'] }}-500 text-white py-2 rounded-lg hover:bg-{{ $menu['color'] }}-600 transition">
                    Kelola
                </a>
            </div>
            @endforeach
