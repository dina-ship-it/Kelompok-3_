...
<div class="bg-white rounded-2xl shadow p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div class="bg-white border rounded-xl shadow-sm p-6 text-center hover:shadow-md transition">
            ...
            <h3 class="text-3xl font-bold text-gray-800">{{ $data['penelitian'] ?? 0 }}</h3>
        ...
        <div class="bg-white border rounded-xl shadow-sm p-6 text-center hover:shadow-md transition">
            ...
            <h3 class="text-3xl font-bold text-gray-800">{{ $data['pengabdian'] ?? 0 }}</h3>
        ...
        <div class="bg-white border rounded-xl shadow-sm p-6 text-center hover:shadow-md transition">
            ...
            <h3 class="text-3xl font-bold text-gray-800">{{ $data['prestasi'] ?? 0 }}</h3>
